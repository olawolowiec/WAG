...
class Interpreter:
  ...
  def visit_VarAccessNode(self, node, context):
    ...
    value = value.copy().set_pos(node.begin, node.end).set_context(context)
  ...
  def visit_BinOpNode(self, node, context):
    ...
    elif node.op_tok.matches(keywordXD, 'ORAZ'):
  ...
  def visit_FuncDefNode(self, node, context):
    ...
    func_value = Function(func_name, body_node, arg_names, node.should_auto_return).set_context(context).set_pos(node.begin, node.end)
  ...
  def visit_CallNode(self, node, context):
    ...
    if res.should_return(): return res
    return_value = return_value.copy().set_pos(node.begin, node.end).set_context(context)
