...
digits = '0123456789'
letters = string.ascii_letters + 'ĄąŻżŹźŃńÓóŚś'
...
class Lexer:
  ...
  def make_tokens(self):
    ...
    while self.current_char != None:
      if self.current_char in ' \t':
        ...
        tokens.append(Token(newlineXD, begin=self.pos))
        self.progress()
        ...
        tokens.append(Token(powXD, begin=self.pos))
        self.progress()
      elif self.current_char == '(':
  ...
  def make_identifier(self):
    ...
    tok_type = keywordXD if id_str in KEYWORDS else identifierXD
